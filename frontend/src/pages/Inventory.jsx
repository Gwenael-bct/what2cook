...
export default function Inventory() {
  ...
  return (
      <>
        <main className="relative flex flex-col min-h-screen bg-[#2B2B2B] p-2 sm:p-4 md:p-8">

          <Header />

          <CurrentUser onUserLoaded={setUser} />

          <div className=" mt-24 mb-12 sm:mt-20 md:mt-24 rounded-xl md:rounded-2xl shadow-xl bg-[#3A3A3A] px-4 sm:px-8 md:px-12
        lg:px-20 py-6 sm:py-8 mx-2 sm:mx-8 md:mx-16 lg:mx-32 xl:mx-48">
            <Particles />
            ...
            {user &&
                <div className="py-4 sm:py-6">
                  <UserIngredients userId={user?.id} key={refreshKey} onIngredientDeleted={handleIngredientAdded} />
                </div>
            }
